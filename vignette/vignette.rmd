...
The HPC used to process these data originally had 24 threads and 128
gigabytes of RAM. Your machine may not be so impressive. This is just
a random downsampling of the data, done only for demonstration purposes.
Real data in a real analysis should not be downsampled.
```{r echo=T}
  set.seed(12345)
