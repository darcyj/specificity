...
`phy_or_env_spec()` is parallelized, and speeds up very nicely using multiple CPU cores. For typical hardware, use 4 or so. If you're using a cluster, know that more cores = more faster.
